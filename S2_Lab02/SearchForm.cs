...
namespace S2_Lab02
{
    public partial class SearchForm : Form
    {
        ...
        private void MenuItemDateTechService_Click(object sender, EventArgs e)
        {
            var orderedResult = from element in _searchResultPlanes
                orderby element.DateTechService
                select element;
        ...
        private void MenuItemSaveSearchResults_Click(object sender, EventArgs e)
        {
            try
            {
                var json = JsonConvert.SerializeObject(_searchResultPlanes);
                using var streamWriter = new StreamWriter(@"data/searchResultSave.json");
